...
endpoint = 'https://discordapp.com/api/guilds/1064651267592421500/members?limit=10'
...
endpoint = 'https://discordapp.com/api/guilds/1064651267592421500/members/478252140348047360/roles/1064657025386152058'
...
#endpoint = "https://discord.com/api/v10/applications/991118685697749032/guilds/1064651267592421500/commands"

# endpoint for creating a new global slash command (which can be used in DM
# with a bot)
# uses application ID
endpoint = "https://discord.com/api/v10/applications/1490871741528932536/commands"


postData = '{ "name": "unlock", "description":"Unlock the Members area.", "type": 1, "options": [ { "name": "secret-words", "description":"Your secret words", "type":3, "required": true } ] }';


# endpoint for deleting guild commands
# use DELETE method (instead of post or get)
#endpoint = "https://discord.com/api/v10/applications/991118685697749032/guilds/1064651267592421500/commands/1064962267067719821"
...
# use GET
# endpoint = "https://discordapp.com/api/guilds/1064651267592421500/roles"
