/* $Id: miniupnpc.c,v 1.6 2010/04/20 13:38:32 jcr13 Exp $ */
/* Project : miniupnp
...
// just define this everywhere... probably won't break anything else
//#ifdef MACOSX
...
#include <arpa/inet.h>
// Changed by Jason Rohrer
// 2010-March-25
// To compile on MacOS 10.2
#ifndef BSD
...
// No poll on BSD either...
...
#else
    fd_set socketSet;
    // where is this coming from?  Jason Rohrer, 2010-March-25
    //TIMEVAL timeval;
    ...
    n = select(FD_SETSIZE, &socketSet, NULL, NULL, &timeV);
    if(n < 0)
    {
